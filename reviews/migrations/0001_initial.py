    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isbn', models.CharField(max_length=20, verbose_name='International Standard Book Number')),
            ],
        ),
        migrations.CreateModel(
            name='Contributor',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reviews_app.book')),
                ('contributor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reviews_app.contributor')),
            ],
        ),
        migrations.AddField(
            model_name='book',
            name='contributors',
            field=models.ManyToManyField(through='reviews_app.BookContributor', to='reviews_app.contributor'),
        ),
        migrations.AddField(
            model_name='book',
            name='publisher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reviews_app.publisher'),
        ),
        migrations.CreateModel(
            name='Review',
            fields=[
                ...
                ('book', models.ForeignKey(help_text='The Book that this review is for', on_delete=django.db.models.deletion.CASCADE, to='reviews_app.book')),
